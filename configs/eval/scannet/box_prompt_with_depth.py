"""WildDet3D + LingBot-Depth on ScanNet - Box prompt + GT depth eval.
...
def get_config() -> ExperimentConfig:
    """WildDet3D + LingBot box-prompt + GT-depth eval on ScanNet."""
    config = get_default_cfg(
        exp_name="wilddet3d_lingbot_depth_freeze21_scannet_box_prompt_with_depth"
    )
