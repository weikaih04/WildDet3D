"""WildDet3D + LingBot-Depth on Omni3D - Box prompt + GT depth eval.

GT 2D boxes + GT depth at inference.
...
def get_config() -> ExperimentConfig:
    """WildDet3D + LingBot box-prompt + GT-depth eval on Omni3D."""
    config = get_default_cfg(
        exp_name="wilddet3d_lingbot_depth_freeze21_omni3d_box_prompt_with_depth"
    )
