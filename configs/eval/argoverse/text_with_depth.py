"""WildDet3D + LingBot-Depth on Argoverse2 - Text + GT depth zero-shot eval.
...
def get_config() -> ExperimentConfig:
    """WildDet3D + LingBot text + GT-depth eval on Argoverse2."""
    config = get_default_cfg(
        exp_name="wilddet3d_lingbot_depth_freeze21_argoverse_with_depth"
    )
