"""WildDet3D + LingBot-Depth on Omni3D - Text + GT depth eval.

Same as text.py but feeds GT depth (depth_input) to LingBot at inference.
...
def get_config() -> ExperimentConfig:
    """WildDet3D + LingBot text + GT-depth eval on Omni3D."""
    config = get_default_cfg(
        exp_name="wilddet3d_lingbot_depth_freeze21_omni3d_with_depth"
    )
