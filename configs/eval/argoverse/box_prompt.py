"""WildDet3D + LingBot-Depth on Argoverse2 - Box prompt (oracle) eval.

Same as text.py but uses GT 2D boxes as geometry prompts
(oracle_eval=True). Isolates 3D regression quality from 2D detection.
"""
...
def get_config() -> ExperimentConfig:
    """WildDet3D + LingBot box-prompt eval on Argoverse2."""
    config = get_default_cfg(
        exp_name="wilddet3d_lingbot_depth_freeze21_argoverse_box_prompt"
    )
