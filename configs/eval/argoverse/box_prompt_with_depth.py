"""WildDet3D + LingBot-Depth on Argoverse2 - Box prompt + GT depth eval.

GT 2D boxes + GT depth fed at inference. Isolates pure 3D box
regression quality given both perfect 2D detection and depth.
"""
...
def get_config() -> ExperimentConfig:
    """WildDet3D + LingBot box-prompt + GT-depth eval on Argoverse2."""
    config = get_default_cfg(
        exp_name="wilddet3d_lingbot_depth_freeze21_argoverse_box_prompt_with_depth"
    )
